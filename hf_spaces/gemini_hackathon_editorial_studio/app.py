"""
Editorial Studio — British Isles Education Workflow Canvas — the gemini_hackathon HF Space.

Headline surface for the editorial_studio stage of the
...
def build_app():
    """Build the editorial_studio Gradio app."""
    with gr.Blocks(
        ...
        # the relevant tab for the editorial_studio stage.
