# Spec Delta: task-runner (Phase 0–11 — replace mise with Make)

This delta is applied by the OpenSpec change
[`2026-08-31-replace-mise-with-make-v1`](../proposal.md). It describes the
**ADDED** Requirements to the canonical `task-runner` capability that
