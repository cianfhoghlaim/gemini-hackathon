...
BOARDS: tuple[BoardMeta, ...] = (
    ...
    BoardMeta(
        code="aqa", name="AQA", jurisdiction="england", official_url="https://www.aqa.org.uk"
    ),
    BoardMeta(
        code="ocr", name="OCR", jurisdiction="england", official_url="https://www.ocr.org.uk"
    ),
    BoardMeta(
        code="pearson",
    ...
    BoardMeta(
        code="sqa", name="SQA", jurisdiction="scotland", official_url="https://www.sqa.org.uk"
    ),
    BoardMeta(
        code="wjec", name="WJEC", jurisdiction="wales", official_url="https://www.wjec.co.uk"
    ),
    BoardMeta(
        code="ccea",
        name="CCEA",
    ...
    BoardMeta(
        code="jersey_ceb",
        name="Jersey Education Department",
        jurisdiction="jersey",
        official_url="https://www.gov.je/education",
    ),
    BoardMeta(
        code="guernsey_esc",
        name="Guernsey Education Services",
        jurisdiction="guernsey",
        official_url="https://www.gov.gg/education",
    ),
    BoardMeta(
        code="iom_desc",
        name="Isle of Man DESC",
...
SUBJECTS: tuple[Subject, ...] = (
    ...
    Subject(
        "wales", "wjec", "wjec-cymraeg-alevel", "Cymraeg A-Level", "a_level", is_welsh_medium=True
    ),
    # Jersey
