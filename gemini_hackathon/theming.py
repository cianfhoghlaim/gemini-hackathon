...
JURISDICTIONS: dict[str, dict[str, Any]] = {
    "ireland": {
        ...
        "name": "Ireland",
        "board_axis": False,
        "official_site": "https://ncca.ie",
    },
    "england": {
        "source_key": "england",
        "name": "England",
        "board_axis": True,
        "official_site": "https://www.gov.uk/education",
    },
    "scotland": {
        "source_key": "sqa.org.uk",
        "name": "Scotland",
        "board_axis": False,
        "official_site": "https://www.sqa.org.uk",
    },
    "wales": {
        "source_key": "wjec.co.uk",
        "name": "Wales",
        "board_axis": False,
        "official_site": "https://www.wjec.co.uk",
    },
    "northern_ireland": {
        "source_key": "ccea.org.uk",
        "name": "Northern Ireland",
        "board_axis": False,
        "official_site": "https://ccea.org.uk",
    },
    "jersey": {
        "source_key": "gov.je/education",
        "name": "Jersey",
        "board_axis": False,
        "official_site": "https://www.gov.je/education",
    },
    "guernsey": {
        "source_key": "gov.gg/education",
        "name": "Guernsey",
        "board_axis": False,
        "official_site": "https://www.gov.gg/education",
    },
    "isle_of_man": {
        "source_key": "gov.im/education",
        "name": "Isle of Man",
        "board_axis": False,
        "official_site": "https://www.gov.im/education",
    },
}
...
BOARDS: dict[str, dict[str, Any]] = {
    ...
    "pearson": {
        "source_key": "qualifications.pearson.com",
...
SAFEGUARDING_BODIES: dict[str, dict[str, Any]] = {
    "gov.ie/education": {
        "name": "Ireland Dept of Education",
        "policy": "DEIS + Well-Being Policy Statement",
    },
    "gov.uk/dfe": {
        "name": "UK Department for Education",
        "policy": "Keeping Children Safe in Education 2026",
    },
    "education.gov.scot": {
        "name": "Scotland Education",
    ...
    "ccea.org.uk/safeguarding": {
        "name": "NI Safeguarding",
        "policy": "Safeguarding and Child Protection",
    },
}
...
def load_palette(source_key: str) -> Palette | None:
...
def _candidate_paths(source_key: str) -> list[Path]:
    ...
    segments = [
        part
        for part in (source_key.replace("/", ".").split("."))
...
def _read_palette(file_path: Path, source_key: str) -> Palette | None:
    try:
...
def list_all_palettes() -> list[dict]:
    ...
    for f in [
        THEMES_DIR / "aqa_palette.json",
        THEMES_DIR / "ocr_palette.json",
        THEMES_DIR / "pearson_palette.json",
    ]:
        pal = _read_palette(f, f.stem)
        if pal:
            palettes.append(
