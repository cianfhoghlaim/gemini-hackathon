# Spec Delta: local-data-plane (Phase 1 — wire the data plane end-to-end)

This delta is applied by the OpenSpec change
[`2026-08-31-local-data-plane-v1`](../proposal.md). It describes the
**ADDED** Requirements to the canonical `local-data-plane` capability
