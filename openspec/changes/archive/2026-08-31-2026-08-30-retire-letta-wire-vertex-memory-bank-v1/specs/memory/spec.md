# Spec Delta: memory (Phase 0)

This delta is applied by the OpenSpec change
[`2026-08-30-retire-letta-wire-vertex-memory-bank-v1`](../proposal.md). It
describes the **ADDED** Requirements to the canonical `memory` capability
