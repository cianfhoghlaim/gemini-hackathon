...
def build_app():
    ...
    with gr.Blocks(
        ...
        gr.Markdown(
            "Scoil Sinsearach (Senior Cycle / Leaving Certificate) — the headline stage. 14 NCCA LC subjects, the LC certificate pipeline, the levy of formative assessment exit cards + the 5 NCCA Key Competencies fan-out."
        )
