# Spec Delta: journey-gradio (Phase 4 — Journey + Gradio polish)

This delta is applied by the OpenSpec change
[`2026-08-31-journey-gradio-polish-v1`](../proposal.md). It describes the
**ADDED** Requirements to the canonical `journey-gradio` capability that
