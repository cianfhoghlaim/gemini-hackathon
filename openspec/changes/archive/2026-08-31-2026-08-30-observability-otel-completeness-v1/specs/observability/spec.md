# Spec Delta: observability (Phase 1)

This delta is applied by the OpenSpec change
[`2026-08-30-observability-otel-completeness-v1`](../proposal.md). It
describes the **ADDED** Requirements to the canonical `observability`
capability that this change adds.
